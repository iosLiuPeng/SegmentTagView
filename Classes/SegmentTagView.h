...
@property (nonatomic, strong) IBInspectable UIFont *titleFont;      ///< 标题字体大小 （默认17.0）

@property (nonatomic, assign) IBInspectable CGFloat minSpace;       ///< 最小间距 (默认10)
@property (nonatomic, assign) IBInspectable CGFloat minWidthProportion; ///< item占父视图宽度的最小比例 （默认0.1）
@property (nonatomic, assign) IBInspectable CGFloat maxWidthProportion; ///< item占父视图宽度的最大比例 （默认0.3）
